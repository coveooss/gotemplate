...
const (
	sprigCrypto         = "Sprig Cryptographic & Security"
	sprigDate           = "Sprig Date"
	sprigDict           = "Sprig Dictionary"
	sprigEncoding       = "Sprig Encoding"
	sprigFilePath       = "Sprig File Path"
	sprigFlow           = "Sprig Flow Control"
	sprigGen            = "Sprig General"
	sprigList           = "Sprig List"
	sprigMath           = "Sprig Mathematics"
	sprigRegex          = "Sprig Regex"
	sprigSemver         = "Sprig Version comparison"
	sprigString         = "Sprig Strings"
	sprigReflect        = "Sprig Reflection"
	sprigDefault        = "Sprig Default"
	sprigOS             = "Sprig OS"
	sprigTypeConversion = "Sprig Type Conversion"
	sprigStringList     = "Sprig String Slice"
	sprigURL            = "Sprig URL functions"
	sprigNetwork        = "Sprig Network functions"
)
